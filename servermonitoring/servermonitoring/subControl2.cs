...
{
    public partial class subControl2 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public subControl2(string serverCd, string serverNm, string serverIp, string testTypeCd, string testTypeNm, string sqlId, string sqlPw, string sqlDbNm, string sqlPort, string location, int sec)
        {
            try
            {
                InitializeComponent();
