...
{
    public partial class TotalsubControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public TotalsubControl()
        {
            InitializeComponent();
        }

        public TotalsubControl(string serverCd, string serverNm, string serverIp, string testTypeCd, string testTypeNm, string sqlId, string sqlPw, string sqlDbNm, string sqlPort, string location, int sec)
        {
            try
            {
                InitializeComponent();
