...
{
    public partial class TotalsubControl2 : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public TotalsubControl2()
        {
            InitializeComponent();
        }

        public TotalsubControl2(string serverCd, string serverNm, string serverIp, string testTypeCd, string testTypeNm, string sqlId, string sqlPw, string sqlDbNm, string sqlPort, string location, int sec)
        {
            try
            {
                InitializeComponent();
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (stat)
                    {
                        ...
                        panel1.BackgroundImage = DXWindowsApplication2.Properties.Resources.ppt1;
                    }
                    else
                    {
                        redColor.Visible = true;
                        panel1.BackgroundImage = DXWindowsApplication2.Properties.Resources.ppt1r;
                    }
                }
            }
            catch (Exception ex)
